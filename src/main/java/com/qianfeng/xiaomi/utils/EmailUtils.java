...
public class EmailUtils {
	public static void sendEmail(User user){
		//发送方
		String myAccount = "18135834662@163.com";
		//授权码
		String myPass = "sjw888";
		//发件人 邮箱的 SMTP 服务器地址
	...
	private static MimeMessage createMsg(Session session, String myAccount, User user) {
		...
		try {
			...
			String url = "http://"+ip+":8080/user/activate.action?e="+ Base64Utils.encode(user.getEmail())+"&c="+Base64Utils.encode(user.getCode());
