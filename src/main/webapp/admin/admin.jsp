		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getGoodsType.action");
				})
				...
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getGoodsList.action");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","addGoods.jsp");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getAllOrder.action");
				})
			</script>
