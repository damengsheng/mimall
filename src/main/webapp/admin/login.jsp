	...
	<div id="main" class="panel panel-primary">
		...
		<div class="panel-body">
			<div style="text-align: center;">
				<img src="../image/mistore_logo.png" alt="logo" width="30%"
					height="30%" />
			</div>
			<form action="${pageContext.request.contextPath }/admin/adminLogin.action"
				method="post">
				...
				<div class="form-group">
					...
					<div class="input-group">
						<input type="password" name="password" id="password"
							class="form-control" placeholder="请输入密码"  value="123456"/> <span
