...
<script type="text/javascript">
	function deleteAddr(id){
		...
		if(res==true){
			window.location.href="/address/deleteaddress.action?id="+id;
		}
	}
	function defaultAddr(id){
		var res = confirm("是否设为默认");
		if(res==true){
			window.location.href="/address/defaultaddress.action?id="+id;
...
<div id="dingdanxiangqing_body">
    <div id="dingdanxiangqing_body_big">
        <div id="big_left">
               ...
               <a id="big_left_a" href="self_center.jsp">我的个人中心</a><br/>
     ...
     <div id="big_right" style="height: 500px;overflow: scroll;">
							...
							<div class="modal fade" tabindex="-1" role="dialog" id="myModal${address.id}">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
									...
									<form action="/address/updateaddress.action" method="post" class="form-horizontal">
		...
		<div class="container" style="width:960px;">
			...
			<form action="${pageContext.request.contextPath}/address/addaddress.action" method="get" class="form-horizontal">
				<div class="form-group">
